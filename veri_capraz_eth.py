"""CAPRAZ-VENUE: MEXC vadeli BTC 1h (data/ETH_fut_1h.csv) vs Binance ETHUSDT 1m -> 1h."""
import glob, numpy as np, pandas as pd
fr=[]
for f in sorted(glob.glob("/home/user/Bot2/eth_data/ETHUSDT-1m-*.csv")):
    d=pd.read_csv(f)
...
M=pd.read_csv("/home/user/Bot2/data/ETH_fut_1h.csv",index_col=0,parse_dates=True)
